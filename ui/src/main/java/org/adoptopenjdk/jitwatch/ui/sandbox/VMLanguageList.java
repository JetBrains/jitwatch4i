...
public class VMLanguageList extends FlowPane implements IStageClosedListener
{
	...
	public VMLanguageList(ContentManager contentManager, final JITWatchConfig config)
	{
			...
			button.setOnAction(new EventHandler<ActionEvent>()
			{
				...
				public void handle(ActionEvent e)
				{
					if (openVMLCStage == null)
					{
						...
						StageManager.addAndShow(contentManager, openVMLCStage, VMLanguageList.this);
					}
				}
			});
