...
public class TriView extends JFXPanelStage implements ILineListener, ICompilationChangeListener
{
	...
	public TriView(Project project, final JITWatchUI parent, final JITWatchConfig config)
	{
		...
		if (viewerBytecode.isOffsetMismatchDetected())
		{
			...
			if (!classBytecodeMismatch)
			{
				...
				Platform.runLater(new Runnable()
				{
					...
					public void run()
					{
						Dialogs.showOKDialog(project, TriView.this, "Wrong classes mounted for log file?",
